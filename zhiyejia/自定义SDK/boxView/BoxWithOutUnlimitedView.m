...
@interface BoxWithOutUnlimitedView ()<UITableViewDelegate,UITableViewDataSource>
{
...
@implementation BoxWithOutUnlimitedView
...
- (void)ActionConfirmBtn:(UIButton *)btn{
    ...
    if (self.boxWithOutUnlimitedViewConfirmBtnBlock) {
        ...
        self.boxWithOutUnlimitedViewConfirmBtnBlock(_ID,_str);
    }
}

- (void)ActionCancelBtn:(UIButton *)btn{
    
    if (self.boxWithOutUnlimitedViewCancelBtnBlock) {
        
        self.boxWithOutUnlimitedViewCancelBtnBlock();
