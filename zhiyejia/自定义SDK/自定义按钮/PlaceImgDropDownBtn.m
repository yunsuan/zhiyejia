...
@implementation PlaceImgDropDownBtn
...
- (UIImageView *)placeImg{
    ...
    if (!_placeImg) {
        ...
        _placeImg.frame = CGRectMake(10 *SIZE, 15 *SIZE, 8 *SIZE, 8 *SIZE);
    }
    return _placeImg;
}
...
- (UILabel *)content{
    ...
    if (!_content) {
        ...
        _content = [[UILabel alloc]initWithFrame:CGRectMake(20 *SIZE, 14 *SIZE, self.frame.size.width - 34 *SIZE, 14 *SIZE)];
