...
- (void)initialiseControl {
    ...
    self.sliderLine.backgroundColor = CLOrangeColor.CGColor;//self.tintColor.CGColor;
    ...
    self.leftHandle.backgroundColor = CLOrangeColor.CGColor;//self.tintColor.CGColor;
    ...
    self.rightHandle.backgroundColor = CLOrangeColor.CGColor;//self.tintColor.CGColor;
    ...
    if (self.minLabelColour == nil){
        self.minLabel.foregroundColor = CLOrangeColor.CGColor;//self.tintColor.CGColor;
    } else {
    ...
    if (self.maxLabelColour == nil){
        self.maxLabel.foregroundColor = CLOrangeColor.CGColor;//self.tintColor.CGColor;
    } else {
