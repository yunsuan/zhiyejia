...
@interface NewRoomHouseHeader ()<UIScrollViewDelegate,UICollectionViewDelegate,UICollectionViewDelegateFlowLayout,UICollectionViewDataSource>
{
...
@implementation NewRoomHouseHeader
...
- (void)ActionImgBtn{
    ...
    if (self.newRoomHouseHeaderImgBtnBlock) {
        
        if (_imgArr.count) {
            
            self.newRoomHouseHeaderImgBtnBlock(_nowNum, _imgArr);
        }
    }
}
