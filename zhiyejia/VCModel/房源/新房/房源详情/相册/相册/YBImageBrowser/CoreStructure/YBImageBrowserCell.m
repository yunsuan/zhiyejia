...
//            self.imageView.image = [UIImage getWaterMarkImage:model.image andTitle:@"云算云渠道" andMarkFont:nil andMarkColor:nil];
            self.imageView.image = [UIImage getAgentWaterImage:model.image andTitle:@"置业家" agent:model.name andMarkFont:nil andMarkColor:nil];
        }else{
            
            self.imageView.image = [UIImage getWaterMarkImage:model.image andTitle:@"置业家" andMarkFont:nil andMarkColor:nil];
        }
