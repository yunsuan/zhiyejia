...
@interface EventListVC ()<UITableViewDelegate,UITableViewDataSource>
{
...
- (void)RequestMethod{
    ...
    [BaseRequest GET:GetProjectActiveList_URL parameters:@{@"info_id":_info_id} success:^(id resposeObject) {

        [self->_listTable.mj_header endRefreshing];
        ...
        if ([resposeObject[@"code"] integerValue] == 200) {
            ...
            if (![resposeObject[@"data"] isKindOfClass:[NSNull class]]) {
                ...
                if (self->_page <= [resposeObject[@"data"][@"last_page"] integerValue]) {

                    self->_listTable.mj_footer.state = MJRefreshStateNoMoreData;
                }
            }else{
...
- (void)RequestAddMethod{
    ...
    [BaseRequest GET:GetProjectActiveList_URL parameters:tempDic success:^(id resposeObject) {

        [self->_listTable.mj_footer endRefreshing];
