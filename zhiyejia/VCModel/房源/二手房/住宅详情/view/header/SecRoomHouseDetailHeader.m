...
@implementation SecRoomHouseDetailHeader
...
- (void)ActionImgBtn{
    ...
    if (self.secRoomHouseDetailHeaderImgBlock) {

        if (_imgArr.count) {

            self.secRoomHouseDetailHeaderImgBlock(_nowNum, _imgArr);
