...
@implementation SecRoomOfficeEquipCollCell
...
- (void)initUI{
    ...
    _typeImg = [[UIImageView alloc] initWithFrame:CGRectMake(20 *SIZE, 10 *SIZE, 32 *SIZE, 32 *SIZE)];
    [self.contentView addSubview:_typeImg];
    
    _titleL = [[UILabel alloc] initWithFrame:CGRectMake(0, 45 *SIZE, 72 *SIZE, 10 *SIZE)];
