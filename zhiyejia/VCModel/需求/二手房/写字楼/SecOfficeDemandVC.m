...
@interface SecOfficeDemandVC ()<UIScrollViewDelegate,UITextViewDelegate,UITextFieldDelegate,UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout>
{
...
@property (nonatomic, strong) UIView *buyUseLine;
...
@implementation SecOfficeDemandVC
...
- (void)initUI{
    ...
    _buyUseLine = [[UIView alloc] init];
    _buyUseLine.backgroundColor = CLLineColor;
    [_useView addSubview:_buyUseLine];
    ...
    [_useView addSubview:_decorateL];
    
    _decorateBtn = [[DropDownBtn alloc] initWithFrame:CGRectMake(80 *SIZE, 0, 270 *SIZE, 42 *SIZE)];
    _decorateBtn.content.text = @"精装";
    [_useView addSubview:_decorateBtn];
...
- (void)MasonryUI{
    ...
    [_buyUseLine mas_makeConstraints:^(MASConstraintMaker *make) {
        
        make.left.equalTo(self->_useView).offset(0 *SIZE);
        make.top.equalTo(self->_buyUseBtn.mas_bottom).offset(0 *SIZE);
        make.width.mas_equalTo(360 *SIZE);
        make.height.mas_equalTo(1 *SIZE);
    }];
    ...
    [_decorateL mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self->_useView).offset(10 *SIZE);
        make.top.equalTo(self->_buyUseLine.mas_bottom).offset(14 *SIZE);
        make.width.mas_equalTo(70 *SIZE);
    }];
    ...
    [_decorateBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(self->_useView).offset(80 *SIZE);
        make.top.equalTo(self->_buyUseLine.mas_bottom).offset(0 *SIZE);
        make.width.mas_equalTo(270 *SIZE);
        make.height.mas_equalTo(42 *SIZE);
