...
@interface DemandSaleCell ()<UICollectionViewDelegateFlowLayout,UICollectionViewDelegate,UICollectionViewDataSource>
{
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    DemandSaleCollCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"DemandSaleCollCell" forIndexPath:indexPath];
    if (!cell) {
        
        cell = [[DemandSaleCollCell alloc] initWithFrame:CGRectMake(0, 0, 338 *SIZE, 135 *SIZE)];
    }
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.demandSaleCellBlock) {
        
        self.demandSaleCellBlock(indexPath.item);
    }
}
...
- (void)initUI{
    ...
    _layout.itemSize = CGSizeMake(338 *SIZE, 135 *SIZE);
    ...
    [_coll registerClass:[DemandSaleCollCell class] forCellWithReuseIdentifier:@"DemandSaleCollCell"];
